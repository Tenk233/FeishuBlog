...
@Service
@Slf4j
public class CozeSentimentService {
    @Value("${coze.api.access-token-sentiment}")
    private String accessToken;

    @Value("${coze.api.workflow_id_sentiment}")
    ...
    private SentimentDTO parseWorkflowData(String workflowData) {
